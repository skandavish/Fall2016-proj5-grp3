...
# head(inputData)
inputDataBup <- inputData[fecha_dato == as.Date('2016-03-28',format="%Y-%m-%d")]
rm(inputData)
...
write.csv(FinalDT,"C:/Users/svish/Documents/Sem 2/Applied Data Science/Project 5/Data/CustomerDataMarch.csv")
