...
# head(inputData)
inputDataBup <- inputData[fecha_dato <= as.Date('2016-02-28',format="%Y-%m-%d")]
rm(inputData)
...
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,SavingsAccount_currSub:= currentProdSub(SavingsAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Guarantees_currSub:= currentProdSub(Guarantees),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,DerivadaAccount_currSub:= currentProdSub(DerivadaAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,JuniorAccount_currSub:= currentProdSub(JuniorAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,MasParticularAccount_currSub:= currentProdSub(MasParticularAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,ParticularAccount_currSub:= currentProdSub(ParticularAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,ParticularPlusAccount_currSub:= currentProdSub(ParticularPlusAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Funds_currSub:= currentProdSub(Funds),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Mortgage_currSub:= currentProdSub(Mortgage),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Pensions_currSub:= currentProdSub(Pensions),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Loans_currSub:= currentProdSub(Loans),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Taxes_currSub:= currentProdSub(Taxes),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,CreditCard_currSub:= currentProdSub(CreditCard),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,Securities_currSub:= currentProdSub(Securities),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,CurrentAccounts_currSub:= currentProdSub(CurrentAccounts),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,DirectDebit_currSub:= currentProdSub(DirectDebit),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,PayRoll_currSub:= currentProdSub(PayRoll),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,PensionsII_currSub:= currentProdSub(PensionsII),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,ShortTermDeposits_currSub:= currentProdSub(ShortTermDeposits),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,MediumTermDeposits_currSub:= currentProdSub(MediumTermDeposits),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,LongTermDeposits_currSub:= currentProdSub(LongTermDeposits),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,EAccount_currSub:= currentProdSub(EAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,PayRollAccount_currSub:= currentProdSub(PayRollAccount),by=CustomerCode]
inputDataBup[month(fecha_dato) == 02 & year(fecha_dato) == 2016,HomeAccount_currSub:= currentProdSub(HomeAccount),by=CustomerCode]
...
write.csv(inputDataBup,'customersTillFeb.csv',row.names = F)



inputData <- fread("C:/Users/svish/Documents/Sem 2/Applied Data Science/Project 5/Data/customersTillFeb.csv")
