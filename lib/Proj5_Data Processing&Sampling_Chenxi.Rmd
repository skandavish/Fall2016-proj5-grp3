...
sample.size=3*10^5 # decide sample size of customer ID
set.seed(2016)
...
length(unique.id.train.samp) #300,000, use 1/5 of the size of the original data (13647309)
...
san.train.samp
dim(san.train.samp) # 4279620 by 48
san.train.samp.n=nrow(san.train.samp)
# original size of data
nrow(san.train)
# size of data after sampling
san.train.samp.n # now  4279620 data in total compared to 13647309 in the original dataset
# how much reduced?
nrow(san.train) - san.train.samp.n #9367689
# str(san.train)
...
# save sampled data
# save original train data
save(san.train.samp,file="san.train.samp(ori feat).RData")
